...
class InnerSelfAttention(nn.Module):
    ...
    def __init__(self, config: StructuredTransformerConfig):
        ...
        bias = torch.tril(torch.ones((max_seq_len, max_seq_len), dtype=torch.bool)).view(
...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, config: StructuredTransformerConfig, layer_id: int, is_seq: bool):
        ...
        self.attn = InnerSelfAttention(config)
        self.pre_mlp_layer_norm = nn.LayerNorm(config.hidden_size, eps=config.layer_norm_epsilon)
